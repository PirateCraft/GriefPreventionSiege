...
import me.ryanhamshire.GriefPrevention.claim.events.ClaimPermissionCheckEvent;
...
public class SiegeEventHandler implements Listener
{
    ...
    public void onClaimPermissionCheck(ClaimPermissionCheckEvent event)
    {
        ...
        else if (event.getTriggeringEvent() instanceof PlayerInteractEvent triggeringEvent)
        {
