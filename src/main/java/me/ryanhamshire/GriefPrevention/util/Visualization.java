...
public class Visualization
{
     ...
     */
    @Deprecated(forRemoval = true, since = "16.18")
    public static Visualization FromClaim(Claim claim, int height, me.ryanhamshire.GriefPrevention.util.VisualizationType visualizationType, Location locality)
    {
     ...
     */
    @Deprecated(forRemoval = true, since = "16.18")
    public static Visualization fromClaims(Iterable<Claim> claims, int height, me.ryanhamshire.GriefPrevention.util.VisualizationType type, Location locality)
    {
        Visualization visualization = new Visualization();
     ...
     */
    @Deprecated(forRemoval = true, since = "16.18")
    public void addClaimElements(Claim claim, int height, me.ryanhamshire.GriefPrevention.util.VisualizationType visualizationType, Location locality)
    {
    ...
    {
        this.boundaries.add(new Boundary(new BoundingBox(min, max), me.ryanhamshire.GriefPrevention.util.VisualizationType.ofBlockData(accentBlockData)));
    }
